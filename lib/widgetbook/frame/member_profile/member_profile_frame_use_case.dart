...
const _widgetbookIntroductionText = '''
...
@widgetbook.UseCase(
  name: 'Default',
  type: MemberProfileFrame,
)
/// [MemberProfileFrame] のデフォルトユースケースです。
Widget memberProfileFrameUseCase(BuildContext context) {
  return ProviderScope(
    overrides: [
      memberProfileUiModelProvider.overrideWithValue(
        const MemberProfileUiModel(
          introductionText: _widgetbookIntroductionText,
        ),
      ),
    ],
    child: const MaterialApp(
      home: MemberProfileFrame(),
    ),
  );
}
